...
\paragraph{Prospective confirmation of a frozen selection rule.} We
then locked the complete rule of Table~\ref{tab:final}, froze every candidate's
...
(0.0020 against 0.0019; quantization-only 0.008). The QA confirmation is an aggregate: the frozen rule beats
quantization-only on three states and trails it on 160M@32k (0.22
against 0.13; Appendix~\ref{sec:app_selection}).  The pruning and quantization candidates are new measurements; the
