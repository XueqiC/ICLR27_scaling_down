...
def _render(data):
    caption = (
        ...
        "cover the text-decoder matrices. Exact revisions and their identifiers, the evidence for "
        "each entry, and the times at which the predictions were fixed are recorded in the repository audit.")
