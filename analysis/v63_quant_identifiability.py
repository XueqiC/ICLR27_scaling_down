...
paper/paper/tables/quant_ident.tex and mirrors this script to paper/analysis/.
...
def main(argv=None):
    ...
    try:
        ...
        if args.write_paper:
            ...
            outputs[root / "paper/analysis/v63_quant_identifiability.py"] = Path(__file__).read_text()
