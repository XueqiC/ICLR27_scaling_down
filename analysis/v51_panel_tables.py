...
def main():
    ...
    L += [r"\bottomrule\end{tabular}",
          ...
          r"Qwen3-8B and Qwen3-14B were added after the panel was assembled and measured with the same protocol. Generated by \texttt{v51\_panel\_tables.py} from \texttt{prune\_losses.json}.}",
    ...
    L += [r"\bottomrule\end{tabular}",
          ...
          r"Qwen3-8B and Qwen3-14B were added after the panel was assembled and measured with the same protocol. Generated by \texttt{v51\_panel\_tables.py} from \texttt{quant\_losses.json}.}", r"\label{tab:panel_quant}\end{table}"]
