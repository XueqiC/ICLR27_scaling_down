...
def _caption_sentences(text):
    openings = {
        ...
        "V75 audit of all 16 V70 distillation forms.": "The V75 audit covers all 16 V70 distillation forms.",
        ...
        "V70 distillation confirmation at ": "The V70 distillation confirmation evaluates ",
