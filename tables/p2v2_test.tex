...
\addlinespace
Gemma-3-4B, dev pools ($U{=}75,450$), held-out student & Math & 0.101 & 0.225 & 0.364 & joint$+$src (0.101) & 12 \\
 & Code & 0.051 & 0.133 & 0.271 & joint$+$src (0.051) & 12 \\
 & QA & 0.862 & 2.255 & 2.279 & joint$+$src (0.862) & 12 \\
\bottomrule
\end{tabular}
\end{table}
