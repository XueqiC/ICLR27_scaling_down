...
SECONDARY CHECK (fresh-sample distributions, all four corners on one card) and the A5 artifact: see results/a5-corner-second-difference/summary.md, regenerated with both students.
