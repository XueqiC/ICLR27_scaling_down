#!/usr/bin/env python3
"""Headline subset of the compact prediction table for the main text. Reads paper/tables/pred_main.tex (generated by
v52), keeps the rows whose label starts with one of KEEP, writes paper/tables/pred_headline.tex (label tab:pred_main)
and paper/tables/pred_full.tex (all rows, label tab:pred_full, [H]) for Appendix D. Numbers are copied verbatim."""
import re; from pathlib import Path
ROOT = Path(__file__).resolve().parents[1]; T = ROOT / "paper/tables"
